...
public final class DeployPredict implements DtObject {
	...
	private io.vertigo.ai.server.domain.DeployResponse response;
	...
	public io.vertigo.ai.server.domain.DeployResponse getResponse() {
		return response;
	}
	 ...
	 */
	public void setResponse(final io.vertigo.ai.server.domain.DeployResponse response) {
