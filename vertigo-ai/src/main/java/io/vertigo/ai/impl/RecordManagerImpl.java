...
public final class RecordManagerImpl implements DatasetManager, Activeable{
	...
	public Future<Long> restoreAll(DatasetDefinition datasteDefinition) {
		...
		executorService.schedule(new RestoreAllTask(DatasetDefinition.class, reindexFuture, this), 5, TimeUnit.SECONDS); //une reindexation total dans max 5s
