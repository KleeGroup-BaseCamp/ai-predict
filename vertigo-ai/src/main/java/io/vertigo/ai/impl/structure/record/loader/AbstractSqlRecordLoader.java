...
/**
 * Default RecordLoader for Database datasource.
 * @author npiedeloup
 * @param <P> Primary key type
 * @param <S> KeyConcept type
 * @param <I> Record type
 */
public abstract class AbstractSqlRecordLoader<P extends Serializable, S extends KeyConcept, I extends DtObject> extends AbstractRecordLoader<P, S, I> {
	 ...
	 */
	@Inject
	public AbstractSqlRecordLoader(
