...
/**
 * Default DatasetLoader for Database datasource.
 * @author npiedeloup
 * @param <P> Primary key type
 * @param <S> KeyConcept type
 * @param <I> Dataset type
 */
public abstract class AbstractSqlDatasetLoader<P extends Serializable, S extends KeyConcept, I extends DtObject> extends AbstractDatasetLoader<P, S, I> {
	 ...
	 */
	@Inject
	public AbstractSqlDatasetLoader(
